...
namespace Capital17_03_COMWord
{
    ...
    class Capital17_03_COMWord
    {
        static void Main(string[] args)
        {
            ...
            wordApp.ActiveWindow.View.Type = MSWord.WdViewType.wdPrintView;//打印视图样式
            ...
            string headerfile = Environment.CurrentDirectory + @"\3.jpg";
            ...
            /// 添加书签
            /// 
            wordDoc.Paragraphs.Last.Range.Text += "新段落";
            wordDoc.Paragraphs.Last.Range.Text += "bookmark";
            wordDoc.Paragraphs.Last.Range.InsertAfter("bookmark\n");
            wordDoc.Bookmarks.Add("Bookmark1", wordDoc.Paragraphs.Last.Range);
            wordDoc.Paragraphs.Last.Range.Text += "";
            wordDoc.Paragraphs.Last.Range.InsertAfter("姓名\n");
            wordDoc.Bookmarks.Add("xingming", wordDoc.Paragraphs.Last.Range);
            wordDoc.Paragraphs.Last.Range.Text += "";
            wordDoc.Paragraphs.Last.Range.InsertAfter("照片\n");
            wordDoc.Bookmarks.Add("zhaopian", wordDoc.Paragraphs.Last.Range);
            wordDoc.Paragraphs.Last.Range.Text += "";
            ///
            /////////////////////////////////////////////////

            // 新段落
            wordDoc.Paragraphs.Last.Range.Text = "新段落1\n";
            //添加在此段的文字后面，不是新段落
            ...
            try
            {
                ...
                for (int i = 1; i < 6; i++)
                {
                    doc.Tables[1].Cell(2, i).Range.Text = "替代";
                }
                
                
                Console.WriteLine("修改表格内文字完成。");
            ...
            /// 在书签Bookmark1位置添加内容
            /// 
            wordDoc.Bookmarks["Bookmark1"].Range.Text= "这是bookmark1里面加的句子";
            wordDoc.Bookmarks["xingming"].Range.Text = "马晨";
            wordDoc.Bookmarks["zhaopian"].Range.InlineShapes.AddPicture(filename);
            wordDoc.InlineShapes[1].Width = 80;
